#!/usr/bin/env python3
"""Startskript fuer den Neo4j Explorer.

Prueft virtuelle Umgebung, installiert fehlende Dependencies und startet Streamlit.
"""
...
REQUIREMENTS = ["streamlit", "neo4j", "pyvis"]
APP = os.path.join(os.path.dirname(os.path.abspath(__file__)), "explorer_app.py")
...
def main():
    ...
    print(f"Starte Neo4j Explorer ({APP}) ...")
