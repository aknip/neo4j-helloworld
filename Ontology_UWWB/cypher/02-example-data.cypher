...
SET r.name = 'Feuer Produktionshalle',
    r.riskType = 'Feuer',
...
SET r.name = 'Maschinenbruch CNC-Fräszentrum',
    r.riskType = 'Maschinenbruch',
...
SET r.name = 'Maschinenbruch Spritzgussanlage',
    r.riskType = 'Maschinenbruch',
...
SET r.name = 'Vollkasko Firmenwagen BMW',
    r.riskType = 'Fahrzeugschaden',
...
SET r.name = 'Vollkasko LKW Mercedes',
    r.riskType = 'Fahrzeugschaden',
...
SET r.name = 'Feuer Lagerhalle München',
    r.riskType = 'Feuer',
...
SET cr.name = 'Feuerdeckung 30 Mio',
    cr.requestedSum = 30000000.0,
...
SET cr.name = 'Maschinenbruch CNC 5 Mio',
    cr.requestedSum = 5000000.0,
...
SET cr.name = 'Maschinenbruch Spritzguss 3 Mio',
    cr.requestedSum = 3000000.0,
    cr.deductible = 25000.0,
    cr.periodStart = date('2024-07-01'),
    cr.periodEnd = date('2025-06-30'),
    cr.status = 'matched',
...
SET cr.name = 'Vollkasko Firmenwagen 200k',
    cr.requestedSum = 200000.0,
...
SET cr.name = 'Vollkasko LKW 500k',
    cr.requestedSum = 500000.0,
    cr.deductible = 5000.0,
    cr.periodStart = date('2024-07-01'),
    cr.periodEnd = date('2025-06-30'),
    cr.status = 'matched',
...
SET s.name = 'Ausschreibung Müller Automotive 2024',
    s.submissionDate = date('2024-03-01'),
...
SET o.name = 'Allianz Sach 450k',
    o.premiumAmount = 450000.0,
...
SET o.name = 'Munich Re Sach 180k',
    o.premiumAmount = 180000.0,
    o.validUntil = date('2024-05-15'),
    o.status = 'accepted',
...
SET o.name = 'Allianz Flotte 35k',
    o.premiumAmount = 35000.0,
    o.validUntil = date('2024-05-15'),
    o.status = 'accepted',
...
SET co.name = 'Feuerdeckung Allianz 30 Mio',
    co.offeredSum = 30000000.0,
...
SET co.name = 'Maschinenbruch Allianz 5 Mio',
    co.offeredSum = 5000000.0,
...
SET co.name = 'Maschinenbruch Allianz 3 Mio',
    co.offeredSum = 3000000.0,
    co.offeredDeductible = 25000.0,
...
SET co.name = 'Feuerdeckung XL Munich Re 30 Mio',
    co.offeredSum = 30000000.0,
...
SET co.name = 'Vollkasko PKW Allianz 200k',
    co.offeredSum = 200000.0,
...
SET co.name = 'Vollkasko LKW Allianz 500k',
    co.offeredSum = 500000.0,
    co.offeredDeductible = 5000.0,
...
SET pol.name = 'Sachversicherung Müller 2024',
    pol.policyNumber = 'POL-2024-001',
...
SET pol.name = 'Flottenversicherung Müller 2024',
    pol.policyNumber = 'POL-2024-002',
    pol.effectiveDate = date('2024-07-01'),
    pol.expirationDate = date('2025-06-30'),
...
SET pc.name = 'Feuerdeckung 30 Mio',
    pc.coveredSum = 30000000.0,
...
SET pc.name = 'Maschinenbruch CNC 5 Mio',
    pc.coveredSum = 5000000.0,
...
SET pc.name = 'Maschinenbruch Spritzguss 3 Mio',
    pc.coveredSum = 3000000.0,
    pc.deductible = 25000.0,
...
SET pc.name = 'Vollkasko Firmenwagen 200k',
    pc.coveredSum = 200000.0,
...
SET pc.name = 'Vollkasko LKW 500k',
    pc.coveredSum = 500000.0,
    pc.deductible = 5000.0,
...
SET e.name = 'Nachtrag Spritzgussanlage Erweiterung',
    e.endorsementNumber = 'END-2024-001',
...
SET cl.name = 'Spindelschaden CNC-Fräszentrum',
    cl.claimNumber = 'CLM-2024-001',
...
SET cs.name = 'Teilregulierung Spindelschaden 400k',
    cs.settlementDate = date('2025-01-10'),
    cs.amount = 400000.0,
...
SET cs.name = 'Schlussregulierung Spindelschaden 350k',
    cs.settlementDate = date('2025-02-28'),
    cs.amount = 350000.0,
