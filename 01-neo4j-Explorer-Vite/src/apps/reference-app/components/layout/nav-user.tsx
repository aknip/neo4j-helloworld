...
import { SignOutDialog } from '@/apps/reference-app/components/sign-out-dialog'
            ...
            >
              ...
              <DropdownMenuGroup>
                <DropdownMenuItem asChild>
                  <Link to={`/${appId}/settings/account` as '/'}>
                    <BadgeCheck />
                    Account
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link to={`/${appId}/settings` as '/'}>
                    <CreditCard />
                    Billing
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link to={`/${appId}/settings/notifications` as '/'}>
                    <Bell />
                    Notifications
                  </Link>
                </DropdownMenuItem>
