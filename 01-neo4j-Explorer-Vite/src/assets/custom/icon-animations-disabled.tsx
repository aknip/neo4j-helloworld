...
export function IconAnimationsDisabled(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      data-name='icon-animations-disabled'
    ...
    >
      ...
      <rect x='32' y='18' width='5' height='24' fill='#ef4444' opacity={0.8} />
      <rect x='43' y='18' width='5' height='24' fill='#ef4444' opacity={0.8} />
      <text
        x='40'
        y='22'
        fontSize='8'
